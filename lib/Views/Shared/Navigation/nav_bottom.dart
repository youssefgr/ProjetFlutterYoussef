...
import 'package:projetflutteryoussef/Views/Youssef/Expenses%20Crud/expenses_list.dart';
...
class _NavBottomState extends State<NavBottom> {
  int _currentIndex = 0;
  final List<Widget> _interfaces = [const Home(), const MediaList(),const ExpensesList(),SubscriptionsList(),SubscriptionAdd()];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.monetization_on), label: "Expenses"),
          BottomNavigationBarItem(icon: Icon(Icons.subscript), label: "Subscriptions"),
          BottomNavigationBarItem(icon: Icon(Icons.subscript), label: "Subscription"),
        ],
